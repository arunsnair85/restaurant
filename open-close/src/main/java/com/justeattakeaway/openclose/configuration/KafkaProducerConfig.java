...
public class KafkaProducerConfig {
	...
	KafkaTemplate<String, String> kafkaTemplate() {
		...
		kafkaTemplate.setProducerListener(new ProducerListener<String, String>() {
			...
			public void onSuccess(ProducerRecord<String, String> producerRecord, RecordMetadata recordMetadata) {
				System.out.println("ACK from ProducerListener message: {} offset:  {}"+ producerRecord.value()+ " "+
	...
	@Bean
	public ProducerFactory<String, RestaurantStatusDTO> userProducerFactory() {
	...
	@Bean
	public KafkaTemplate<String, RestaurantStatusDTO> userKafkaTemplate() {
